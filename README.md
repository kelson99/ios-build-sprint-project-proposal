...
2. App Name: Are we there yet?
3. App Description (3-5 sentences):

    You can use this app to countdown to important events such as a birthday or important day in your life. You will know how many hours, minutes, seconds until that moment arrives. That helps build the excitement. 
    
4. Your #1 Customer (Who would use your app? Why now?)
 
   Honestly, anyone. This is not a very difficult app to use nor is it directed towards any demographic or age group.
    
5. Github code repository: https://github.com/kelson99/IOS-Build-week-Unit-1
6. Github Project/Trello Board: https://trello.com/b/bWAqhwpa/build-week-1
...
1. Customize background image of app.
2. Notes for the upcoming event.
3. Customize Text and color of countdown timer.
